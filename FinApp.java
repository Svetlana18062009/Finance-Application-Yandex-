...
public class FinApp {
        public static void main(String[] args) {
            ...
            double rateEUR = 85;//Курс евро
            double rateJPY = 0.74;//Курс японской йены
            ...
            while (true) {// Бесконечный цикл
                ...
                System.out.println("4 — Вывести траты за неделю");
                ...
                if (command == 1) {
                    ...
                    for(int i=0;i<expenses.length;i++){
                        System.out.println("За день " + (i+1)
                                + " потрачено " + expenses[i] + "руб.");
                    }
